...
// ✅ ServiceTableRow: Matches ProductTableRow styling exactly
        ...
        <tr className="group border-b border-slate-50 last:border-none hover:bg-slate-50/50 transition-colors">
            ...
            <td className="py-4 align-middle">
                <span className="text-[10px] font-bold uppercase bg-purple-50 text-purple-600 px-2 py-1 rounded">
                    {s.category?.name || s.category || 'General'}
                </span>
            </td>
...
export function ManagementView({
    ...
    // ✅ Replaced custom delete modal with standard confirm to match ProductsView
    ...
    return (
        // ✅ FIX: Removed "md:p-0" to match ProductsView padding exactly
