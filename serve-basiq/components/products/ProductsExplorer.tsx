...
import { Filter, PackageOpen, MapPin, X, SlidersHorizontal } from 'lucide-react';

// Hooks
import { useProductsExplorer, CategoryData } from '@/app/hook/useProductsExplorer';
...
export default function ProductsExplorer() {
    ...
    const availableCategories = useMemo(() => {
        ...
        // Fallback: Extract from products if API empty
    ...
    return (
        <section className="min-h-screen bg-slate-50 text-slate-800 pb-20 pt-8">
