        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div ref={modalRef} className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden relative animate-in zoom-in-95 duration-200">
                        <button onClick={() => setIsOpen(false)} className="absolute top-4 right-4 text-white hover:text-slate-200 bg-black/20 hover:bg-black/40 backdrop-blur-md rounded-full p-2 transition z-10">
                            <FaXmark size={18} />
                        </button>
                        ...
                        <div className="px-6 pb-8 -mt-16 relative">
                            ...
                            <div className="text-center mb-6">
                                <h3 className="text-xl font-black text-slate-900 flex items-center justify-center gap-2 mb-1">
                                    {displayName}
                                    {supplier.isVerified && <FaCircleCheck className="text-blue-500 text-base" />}
                                </h3>
