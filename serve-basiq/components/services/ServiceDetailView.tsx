...
interface ServiceDetailViewProps {
    service: {
        ...
        rating: number | string; // Allow decimal or string
        ...
        // ✅ FIXED: Changed id from string to number | string to match DB
        reviews: {
            id: number | string;
            rating: number;
        }[];
...
export default function ServiceDetailView({ service, loggedInUser }: ServiceDetailViewProps) {
