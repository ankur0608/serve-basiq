...
// import ProductWrapper from '@/components/products/ProductWrapper'; // ✅ Import Wrapper
...
//   // 3. Fetch Current User & Addresses for the Booking Flow
...
export default async function ProductDetail({ params }: Props) {
  ...
  // 3. ✅ Fetch Current User (Works for Google & Mobile/OTP)
  const session = await getServerSession(authOptions);
  let currentUserAddresses: any[] = [];
